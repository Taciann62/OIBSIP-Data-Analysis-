...
#### View the retail sales data to see the rows and columns it contains. Please remember, I have formatted the date in the spreadsheet. On R, the data was seen to have contained data from 2024 and seeing that I would be working on the Annual sales, I filtered the data only to contain details from 2023.

```R
Retail_sales<-Retail_data%>%
filter(Year==2023)
```
```R
View(Retail_sales)
